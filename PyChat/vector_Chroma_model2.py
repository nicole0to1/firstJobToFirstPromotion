...
# Initialize sentence transformer for embeddings using all-mpnet-base-v2 model
...
def main():
    print("Welcome to the ChromaDB Vector Search with all-mpnet-base-v2! Type 'exit' or 'quit' to leave.")
